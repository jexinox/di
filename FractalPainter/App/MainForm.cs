...
namespace FractalPainting.App
{
    ...
    {
        public MainForm(IUiAction[] actions, PictureBoxImageHolder pictureBoxImageHolder, Palette palette)
        {
            ...
            DependencyInjector.Inject<IImageHolder>(actions, pictureBoxImageHolder);
